...
export const users = pgTable('users', {
  ...
  mfaEnrolledAt: timestamp('mfa_enrolled_at', { mode: 'date' }),
  ...timestamps
});

export const instanceSettings = pgTable('instance_settings', {
  id: text('id').primaryKey().default('global'),
  globalMfaEnabled: boolean('global_mfa_enabled').notNull().default(false),
  updatedAt: timestamp('updated_at', { mode: 'date' })
    .notNull()
    .default(sql`now()`)
});
...
export const sessions = pgTable(
  'sessions',
  {
    ...
    isMfaComplete: boolean('is_mfa_complete').notNull().default(true),
    createdAt: timestamp('created_at', { mode: 'date' })
      .notNull()
      .default(sql`now()`)
  },
...
export const mfaBreakGlassTokens = pgTable(
...
export const userIdentities = pgTable(
  'user_identities',
  {
    ...
    linkedAt: timestamp('linked_at', { mode: 'date' }).notNull(),
    createdAt: timestamp('created_at', { mode: 'date' })
      .notNull()
      .default(sql`now()`)
  },
...
export const userInvitations = pgTable(
  'user_invitations',
  {
    ...
    acceptedByUserId: text('accepted_by_user_id').references((): AnyPgColumn => users.id, {
      onDelete: 'set null'
    }),
    expiresAt: timestamp('expires_at', { mode: 'date' }).notNull(),
...
export const models = pgTable(
  'models',
  {
    ...
    hasZdrProvider: boolean('has_zdr_provider').notNull().default(false),
    hasNoPromptTrainingProvider: boolean('has_no_prompt_training_provider')
      .notNull()
      .default(false),
    hasHipaaCompliantProvider: boolean('has_hipaa_compliant_provider')
      .notNull()
      .default(false),
    enabled: boolean('enabled').notNull().default(true),
...
// ────────────────────────────────────────────────────────────────
export const accessibleProviders = pgTable('accessible_providers', {
  id: text('id').primaryKey(),
...
export const accessibleModels = pgTable(
  'accessible_models',
  {
    id: text('id').primaryKey(),
...
export const virtualKeyModels = pgTable(
  'virtual_key_models',
  {
